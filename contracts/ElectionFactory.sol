...
// 	function createElection(string memory _name, uint _startTime, uint _endTime) public {
// 		Election newElection = new Election(_name, _startTime, _endTime);
...
// 		) public ownerOnly {
// 		// require(now > startTime, 'Cannot add candidates during election");
...
// 		require(now >= endTime, 'Election time is not over yet.');
